...
//!
//! Like an ISIN, a CFI has no conventional punctuated form: its canonical rendering *is* the
//! compact 6-character string. There is therefore no separate zero-allocation formatted-string
//! helper — [`Cfi::as_str`](crate::cfi::Cfi::as_str) already returns the canonical form.
