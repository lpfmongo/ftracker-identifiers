//! Turns raw user input into a normalized 6-byte ASCII candidate ready for
//! [`super::validation`].
//!
//! This module only knows about *formatting*: trimming surrounding whitespace a CFI might pick up
//! from a spreadsheet cell or CSV column, and folding ASCII case. A CFI has no conventional
